...
<script src="{{!\App::environment('local')?secure_asset('plugins/jquery-validation/jquery.validate.js'):asset('plugins/jquery-validation/jquery.validate.js')}}"></script>

<!-- Custom Js -->
<script src="{{!\App::environment('local')?secure_asset('js/admin.js'):asset('js/admin.js')}}"></script>
<script src="{{!\App::environment('local')?secure_asset('js/pages/examples/sign-in.js'):asset('js/pages/examples/sign-in.js')}}"></script>
